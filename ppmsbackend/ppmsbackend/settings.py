"""
Django settings for ppmsbackend project.
...
SECRET_KEY = 'django-insecure-qa@f$=+$!5e)v$+b@p&nk&b$4vw!xq801#_@j*dzdd-n^mr%@l'
...
WSGI_APPLICATION = 'ppmsbackend.wsgi.application'
