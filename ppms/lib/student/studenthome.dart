                    ...
                    children: [
                      Container(
                        ...
                        child: ListView(children: [
                          ...
                          ListTile(
                            title: Text('Guide Consent form for ID Program'),
                            onTap: () => launchUrl(Uri.parse(
                          ...
                          ListTile(
                            title: Text('Doctoral Committee Constitution form'),
                            onTap: () => launchUrl(Uri.parse(
                          ...
                          ListTile(
                            title: Text('Comprehensive Exam evaluation form'),
                            onTap: () => launchUrl(Uri.parse(
                        ...
                        child: ListView(children: [
                          ...
                          if (academicDetails?.dcMeet1 != null)
                            ListTile(
                              ...
                              subtitle: Text(academicDetails?.dcMeet1 ?? ''),
                            ),
                          if (academicDetails?.jrfSrfConversion != null)
                            ListTile(
                              ...
                              subtitle:
                                  Text(academicDetails?.jrfSrfConversion ?? ''),
                            ),
                          if (academicDetails?.dcMeet2 != null)
                            ListTile(
                              ...
                              subtitle: Text(academicDetails?.dcMeet2 ?? ''),
                            ),
                          if (academicDetails?.dcMeet3 != null)
                            ListTile(
                              ...
                              subtitle: Text(academicDetails?.dcMeet3 ?? ''),
                            ),
                          if (academicDetails?.dcMeet4 != null)
                            ListTile(
                              ...
                              subtitle: Text(academicDetails?.dcMeet4 ?? ''),
                            ),
                          if (academicDetails?.dcMeet5 != null)
                            ListTile(
                              ...
                              subtitle: Text(academicDetails?.dcMeet5 ?? ''),
                            ),
                          if (academicDetails?.dcMeet6 != null)
                            ListTile(
                              ...
                              subtitle: Text(academicDetails?.dcMeet6 ?? ''),
                            ),
                          if (academicDetails?.dcMeet7 != null)
                            ListTile(
                              ...
                              subtitle: Text(academicDetails?.dcMeet7 ?? ''),
                            ),
